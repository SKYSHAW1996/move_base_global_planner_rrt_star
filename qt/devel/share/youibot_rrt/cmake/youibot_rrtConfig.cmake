...
if(NOT "/home/sikai/catkin_ws_project/src/youibot_rrt/include " STREQUAL " ")
  set(youibot_rrt_INCLUDE_DIRS "")
  set(_include_dirs "/home/sikai/catkin_ws_project/src/youibot_rrt/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'youibot_rrt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sikai/catkin_ws_project/src/youibot_rrt/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sikai/catkin_ws_project/src/youibot_rrt/qt/devel/lib;/home/sikai/youibot_ws/devel/lib;/opt/ros/kinetic/lib)
